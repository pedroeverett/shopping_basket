...
public abstract class FreshFood implements Sellable {
  ...
  public FreshFood(String name, String brand, double price, int barCode, int ageRestriction, String expirationDate, boolean buyOneGetOneFree) {
    this.name = name;
    this.brand = brand;
    this.price = price;
